...
general_info = human_genome.information()
...
sequence_IDs = human_genome.unique_sequence_IDs()
...
chromosomes = human_genome.chromosomes()
print(chromosomes.get_df().head())
print(chromosomes.get_df().shape)
print()
print()

fraction = human_genome.fraction_of_unassembled_sequencesuencesuences()
...
gene_names = human_genome.gene_names()
print(gene_names.get_df().head())
print(gene_names.get_df().shape)
print()
print()

types = human_genome.unique_types()
print(types.get_df().head())
print(types.get_df().shape)
print()
print()

entries_for_types = human_genome.entries_for_each_type()
print(entries_for_types.get_df().head())
print(entries_for_types.get_df().shape)
print()
print()

entries_for_types_ensemblehavana = human_genome.entries_for_each_type_ensemblhavana()
